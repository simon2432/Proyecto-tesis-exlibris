...
export default function FavoritosBuscar() {
  ...
  const { setLibroFavorito } = useUser();
    ...
    <View style={{ flex: 1, backgroundColor: "#FFF" }}>
      <View style={styles.headerRow}>
        <TouchableOpacity
          ...
          onPress={() => router.replace("/favoritos-editar")}
        >
            ...
            <View key={idx} style={styles.row}>
              {fila.map((book) => (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    setLibroFavorito?.(parseInt(slot ?? "0"), {
                      id: book.id,
                      portada: book.image || "https://placehold.co/90x120",
                      title: book.title || "",
                    });
                    router.replace("/favoritos-editar");
                  }}
                >
                  <ExpoImage
                    source={{
